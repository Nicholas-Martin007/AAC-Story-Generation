...
class JSONEncoderConverter(json.JSONEncoder):
...
def find_ner_tags(
    ...
    # with open(
    #     'dataset/data_with_ner_tags.json',
    #     'w',
    #     encoding='utf-8',
    # ) as f:
    #     json.dump(
...
def apply_ner_tags(
    ...
    for data in dataset:
        ...
        ner_tags = concat_entity(data['ner_tag'])
        tagged_sentence = insert_entity_tags(
            ner_tags,
            data['data'],
        )
    ...
    with open(
        'dataset/applied-ner-dataset.json',
        'w',
        encoding='utf-8',
    ) as f:
        json.dump(
