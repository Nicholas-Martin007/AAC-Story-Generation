...
def manual_ner(tokenizer: AutoTokenizer, model: AutoModelForTokenClassification, sentence: str) -> None:
    '''
    To see details of the NER model
    '''
    colors_list = [
        '255;99;132', '54;162;235', '255;206;86', '75;192;192', '153;102;255',
        '255;159;64', '199;199;199', '83;102;255', '255;102;255', '102;255;178',
        '255;204;153', '204;255;102', '255;153;204', '102;153;255', '255;255;102',
        '102;255;255', '204;153;255', '255;102;153', '153;255;204', '178;102;255',
        '255;102;102', '102;255;153', '255;178;102', '153;255;255', '255;153;102',
        '204;255;255', '102;204;255', '255;255;204', '204;204;255', '255;204;229',
        '204;255;229', '255;229;204', '229;204;255', '255;255;255', '192;192;192',
        '255;51;153', '153;255;51', '51;153;255', '0;0;0'
    ]
...
def concat_entity(outputs):
    ...
    for entity in outputs:
        ...
        if(prev is None or prev["entity_group"] != curr_entity or curr_start != prev["end"]):
            if prev is not None:
                storage.append(prev)
